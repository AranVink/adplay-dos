...
void CWindow::redraw(void)
{
	unsigned char i,j,wndx,wndy=0;
        const unsigned char window_upper_left_char = 218;   // Window box upper left code page 437,      unicode representation: ┌
        const unsigned char window_upper_right_char = 191;  // Window box upper right code page 437,     unicode representation: ┐
        const unsigned char window_bottom_left_char = 192;  // Window box lower left code page 437,      unicode representation: └
        const unsigned char window_bottom_right_char = 217; // Window box lower right code page 437,     unicode representation: ┘
        const unsigned char window_horizontal_line = 196;   // Window box horizontal bar  code page 437, unicode representation: ─
        const unsigned char window_vertical_line = 179;     // Window box vertical bar code page 437,    unicode representation: │
